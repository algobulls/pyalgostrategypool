from strategy.core.strategy_options_base_v2 import StrategyOptionsBaseV2, OptionsStrikeDirection, OptionsTradingsymbolSuffix, OptionsInstrumentDirection


class StrategyOptionsStrangle(StrategyOptionsBaseV2):
    name = 'Options Strangle Template'
