"""
    Strategy Description:
        The Options Bull Put Ladder Intraday strategy involves using a multi-leg options setup, where a combination of Put options are bought and sold at different strike prices.
        This strategy includes three legs, each with varying strikes and transaction types, aimed at capitalizing on intraday market movements.
        It is typically used in a neutral to bullish market outlook to profit from volatility while limiting downside risk.
...
class OptionsBullPutLadderIntraday(StrategyOptionsBase):
    name = 'Options Bull Put Ladder Intraday'
