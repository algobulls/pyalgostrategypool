"""
    Strategy Description:
        The Options Bear Put Ladder Intraday strategy creates a three-leg put options spread for bearish market conditions.
        It involves buying and selling put options at different strike prices (ITM, ATM, OTM) to manage risk and reward.
        This intraday strategy seeks to capitalize on downward market movements while controlling exposure.
...
class StrategyStrategyOptionsBearPutLadderIntraday(StrategyOptionsBase):
    name = 'Strategy Strategy Options Bear Put Ladder Intraday'
