"""
    Strategy Description:
        The Options Long Iron Butterfly Intraday strategy involves setting up a multi-leg options position using both calls and puts at different strike prices to capitalize on low volatility.
        It combines buying and selling of options in a specific order to create a limited risk, limited reward position.
        This strategy is generally employed in range-bound market conditions, aiming to profit from minimal price movement while managing risk efficiently.
...
class StrategyOptionsLongIronButterflyIntraday(StrategyOptionsBase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._leg_four_strike_direction = OptionsStrikeDirectionMap[self.strategy_parameters.get('LEG_FOUR_STRIKE_DIRECTION', 2)]  # ITM: 0| ATM: 1| OTM: 2
