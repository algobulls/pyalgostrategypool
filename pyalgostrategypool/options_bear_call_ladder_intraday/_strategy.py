"""
    Strategy Description:
        The Options Bear Call Ladder Intraday strategy constructs a three-leg options spread using call options with varying strikes.
        It involves buying and selling call options at specific strike directions (ITM, ATM, OTM) to manage risk and reward dynamically.
        The strategy is designed for intraday trading, focusing on limited risk while capturing potential bearish market movements.
...
class OptionsBearCallLadderIntraday(StrategyOptionsBase):
    name = 'Options Bear Call Ladder Intraday'
