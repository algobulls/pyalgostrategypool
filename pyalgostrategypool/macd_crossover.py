...
class MACDCrossover(StrategyBase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        assert (0 < self.fastma_period == int(self.fastma_period)), f"Strategy parameter SLOWMA_PERIOD should be a positive integer. Received: {self.fastma_period}"
    ...
    def get_decision(self, instrument, decision):
        ...
        macdline, macdsignal, _ = talib.MACD(hist_data['close'], fastperiod=self.fastma_period, slowperiod=self.fastma_period, signalperiod=self.signal_period)
