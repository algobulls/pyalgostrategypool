"""
    checkout:
        - strategy specific docs here : https://algobulls.github.io/pyalgotrading/strategies/options_box_spread/
...
class OptionsBoxSpread(StrategyOptionsBaseV2):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._leg_one_strike_direction = self.strategy_parameters.get('LEG_ONE_STRIKE_DIRECTION', 0)  # ITM: 0| ATM: 1| OTM: 2
        ...
        self._leg_three_transaction_type = self.strategy_parameters.get('LEG_THREE_TRANSACTION_TYPE', 1)  # BUY: 1 | SELL: 2
