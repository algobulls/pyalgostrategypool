"""
    Strategy Description:
        The Options Bull Call Ladder Intraday strategy involves executing a multi-leg options trade where a combination of Call options are bought and sold at different strike prices.
        The strategy consists of three legs, with varying strikes and transaction types, to take advantage of intraday market movements.
        This strategy is typically used in a neutral to bullish market outlook.
...
class StrategyStrategyOptionsBullCallLadderIntraday(StrategyOptionsBase):
    name = 'Strategy Strategy Options Bull Call Ladder Intraday'
